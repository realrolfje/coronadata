...
# zie 
vaccins_totaal = {
    'x':            [ parser.parse("2021-01-06"), parser.parse("2021-01-17"), parser.parse("2021-01-24"), parser.parse("2021-01-31"), parser.parse("2021-02-07"), parser.parse("2021-02-14"), parser.parse("2021-02-21"), parser.parse("2021-02-28"), parser.parse("2021-03-07")],          #'x':           
    'astra_zeneca': [                          0,                          0,                          0,                          0,                          0,                          0,                      13386,                      63002,                     120674],          #'astra_zeneca':
    'pfizer':       [                          0,                      77000,                     146612,                     337526,                     552626,                     761227,                     961083,                    1200649,                    1405954],          #'pfizer': (gecombineerd met AZ, rapportage maakt geen splitsing)      
    'cure_vac':     [                          0,                          0,                          0,                          0,                          0,                          0,                          0,                          0,                          0],          #'cure_vac':    
    'janssen':      [                          0,                          0,                          0,                          0,                          0,                          0,                          0,                          0,                          0],          #'janssen':     
    'moderna':      [                          0,                          0,                          0,                       6000,                      18519,                      22211,                      39570,                      72747,                      93211],          #'moderna':     
    'sanofi':       [                          0,                          0,                          0,                          0,                          0,                          0,                          0,                          0,                          0],          #'sanofi':      
    'totaal':       [                          0,                      77000,                     146612,                     343526,                     571145,                     793438,                    1014039,                    1336398,                    1619839]           #'totaal':      
}
